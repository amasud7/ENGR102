...
print(f'a = {a}')
b = a * 7
print(f'b = a * 7 = {b}') # Yes, since we have no roundoff it is 1.0
c = 2 * a
d = 5 * a
f = c + d
print(f'f = 2 * a + 5 * a = {f}') # We have roundoff so it is not 1.0
from math import sqrt
x = sqrt(1 / 3)
print(f'x = {x}')
y = x * x * 3
print(f'y = x * x * 3 = {y}') # We have no roundoff so the value is 1.0
z = x * 3 * x
print(f'z = x * 3 * x = {z}') # We do have roundoff error so the value is not 1.0
